 ...
 * Author: 3urobeat
 *
 * Last Modified: 2025-12-31 12:56:57
...
import { getClothes, upsertClothing } from "~/composables/useClothesDb";
import { deleteImage, getAllImagePaths, imgCategory } from "~/composables/useImagesStorage";
import { getAllLabelCategories, getAllLabels, removeLabels } from "~/composables/useLabelsDb";
import { getOutfit, upsertOutfit } from "~/composables/useOutfitsDb";
