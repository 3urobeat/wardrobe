 ...
 * Author: 3urobeat
 *
 * Last Modified: 2025-09-09 17:13:45
...
<template>
    <div id="title" class="absolute w-full right-5 mb-5 lg:mb-7 pt-10 select-none">
        ...
        <div class="flex justify-end items-center">
            <NuxtLink to="/labels/add" class="flex items-center justify-center py-1 px-3 rounded-sm bg-bg-input-light dark:bg-bg-input-dark outline-border-primary-light dark:outline-border-primary-dark outline-2 hover:bg-bg-input-hover-light hover:dark:bg-bg-input-hover-dark hover:transition-all">
